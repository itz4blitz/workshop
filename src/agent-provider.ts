export const AGENT_PROVIDER_IDS = ["claude", "codex", "copilot"] as const;

export type AgentProviderId = typeof AGENT_PROVIDER_IDS[number];

export const AGENT_ANNOTATION_SOURCES = ["claude-code", "codex", "copilot"] as const;
...
export const AGENT_PROVIDERS: Record<AgentProviderId, AgentProviderDefinition> = {
  ...
  copilot: {
    ...
    annotationSource: "copilot",
    cliCommand: "copilot",
    defaultSlashCommands: ["/clear", "/resume", "/plan", "/review", "/mcp", "/pr"],
  },
};
